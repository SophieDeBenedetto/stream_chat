defmodule StreamChatWeb.CoreComponents do
  ...
  def message_list(assigns) do
    ~H"""
    <div class="mt-2">
      <div :for={message <- @message} id={message.dom_id}>
        <dl class="-my-4 divide-y divide-zinc-100">
          <div class="flex gap-4 py-4 sm:gap-2">
            ...
            <dt
              class="w-1/8 flex-none text-[0.8125rem] leading-6 text-zinc-500"
              style="font-weight: 900"
            >
              <%= message.title %> <span style="font-weight: 300">[<%= message.created_at %>]</span>
            </dt>
          </div>
        </dl>
        <dl class="-my-4 divide-y divide-zinc-100">
